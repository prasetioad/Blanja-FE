        ...
        <div className="row">
          {getNewProduct !== undefined
            ? getNewProduct.map((item) => {
                return (
                  <div className="col-2.5 ml-3 mb-5" key={item.id}>
                    <div className={style["card"]}>
                      <img
                        ...
                        src="https://www.fashionrevolution.org/wp-content/uploads/2020/11/gez-xavier-mansfield-b34E1vh1tYU-unsplash.jpg"
                        alt=""
                      />
                      <div className="card-body">
                        ...
                        <img
                          ...
                          src="https://www.flaticon.com/svg/vstatic/svg/786/786230.svg?token=exp=1620118115~hmac=a4e96f09c345196119a6f8470b55151f"
                          alt=""
                        />
                      </div>
                    </div>
