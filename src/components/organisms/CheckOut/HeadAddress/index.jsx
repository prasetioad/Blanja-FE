...
export default function HeadAddress() {
    ...
    return (
        <div className="box-head-add" id='main'>
            <h4>Andreas Jane</h4>
            <p> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quis at et ea tempora necessitatibus rerum quibusdam modi laboriosam. Atque, aut!</p>
            <button onClick={()=>{openModal()}}>Choose Another Address</button>
            <Modal
          isOpen={modalIsOpen}
        //   onAfterOpen=''
          ...
          <div className="reactModalPlakat">
              ...
              {addAddress == false && <>
                  ...
                  <div className="reactModalAddNewAdd">
                      <span onClick={()=>{setaddAddress(true)}}>Add new address</span>
                  </div>
                                    ...
                                    <form action="">
                                        <div className="reactModalAddressTop">
                                            <div className="inputTopAddAddress">
                                                ...
                                                <input type="text" placeholder="Rumah" name='addressName' onChange={(e)=>{onChangeInput(e)}}/>
                                            </div>
                                        </div>
                                        <div className="reactModalAddAddressFlex">
                                            <div className="reactModalAddAddressFlexLeft">
                                                <div className="addAddressFlexLeftItem">
                                                    ...
                                                    <input type="text" name='recipient' onChange={(e)=>{onChangeInput(e)}}/>
                                                </div>
                                                <div className="addAddressFlexLeftItem">
                                                    <p>Address</p>
                                                ...
                                                <div className="addAddressFlexLeftItem">
                                                    ...
                                                    <input type="text" name='city' onChange={(e)=>{onChangeInput(e)}}/>
                                                </div>
                                                <div className="addAddressFlexLeftItem checkboxAddAddress">
                                                    <div>
                                                        <input type="checkbox" className='' name='checkbox' onChange={(e)=>{onChangeInput(e)}}/>
                                                    </div>
                                                    <div>
                                            ...
                                            <div className="reactModalAddAddressFlexLeft">
                                                <div className="">
                                                    ...
                                                    <div className="addAddressFlexLeftItem">
                                                        <p>Postal code</p>
                                                        <input type="text" name='postalCode'onChange={(e)=>{onChangeInput(e)}}/>
                                                    </div>
                                                </div>
                                                <div className='reactModalAddAddressButtons'>
                                                    <div className="reactModalAddButtonItem">
                                                        <Button btnClr='white' cls='addAddressButtonsItm' ftClr="#9B9B9B" func={()=> closeAddAddress()} val='Cancel'  style={{border: '1px solid #9B9B9B'}}/>
                                                    </div>
                                                    <div className="reactModalAddButtonItem">
                                                        <Button btnClr={'#273AC7'} cls='addAddressButtonsItm' ftClr="white" func='' val='Save'   />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
