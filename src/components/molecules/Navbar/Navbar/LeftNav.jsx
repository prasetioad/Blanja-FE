      ...
      <div className={css.navbarLeftSideNoCenter}>
        <div className={"displayColumn " + css.searchBorder}>
          <div className={"displayRow " + css.searchInputArea}>
            <input className={css.inputSearch} onChange={ (e) => { searchInputChange(e) } } placeholder="Search ..." value={keyword}/>
          ...
          <div className={"displayRow " + css.searchResult} style={{justifyContent: "center"}}>
              <span className={css.productCategory}>Can't found any products you wanted</span>
          </div>
          :
